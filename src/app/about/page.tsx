...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-column">
      <Navbar />
      <main className="py-20 px-4 flex-grow">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-16 shadow-sm border border-gray-100">
          ...
          <div className="prose prose-blue max-w-none text-gray-600 space-y-10 leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-100">쏟아지는 AI 툴, 이제 한 곳에서 찾으세요.</h2>
              ...
              <div className="space-y-10 text-lg">
                ...
                <div className="pt-10 border-t border-gray-100 text-sm text-gray-500">
                  <h4 className="font-bold text-gray-700 mb-2 text-base">면책 고지</h4>
                ...
                <div className="pt-2">
                  <h4 className="font-bold text-gray-700 mb-2 text-base">문의</h4>
                  <p>오류 제보 및 툴 추가 요청, 피드백은 아래 이메일로 보내주세요.</p>
                  <p className="mt-2">📧 <a href="mailto:cocori7654@gmail.com" className="text-blue-600 hover:underline">cocori7654@gmail.com</a></p>
                </div>
              </div>
            </section>
          </div>
